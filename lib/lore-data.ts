...
export const CHAPTERS: LoreChapter[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { year: 2523, title: "Ivar Messer seizes power", tag: "politics",
        body: "Using a manufactured Tevarin invasion scare, General Ivar Messer dissolves the UPE Senate and crowns himself First Citizen. The empire has a dictator for the first time." },
    ],
    panels: [
      {
  ...
  },
  {
    ...
    events: [
      ...
      { year: 2610, title: "Tevarin defeated, homeworld terraformed", tag: "war",
        body: "The UEE wins the First Tevarin War and, in an act whose shame echoes to this day, terraforms the Tevarin homeworld Kaleeth into a UEE colony. The surviving Tevarin become refugees across human space." },
      { year: 2681, title: "Second Tevarin War", tag: "war",
        body: "The last Tevarin warlord, Corath'Thal, gathers the diaspora and retakes Kaleeth for a single desperate month. He is killed in orbit. The Tevarin never rise again." },
